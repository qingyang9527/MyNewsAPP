...
public class TiYuFragment extends Fragment {
    ...
    public void showData(){
        ...
        Observable<TianNews> observable=tianAPI.getAllNews("tiyu",CommonUtil.KEY,30,0,1);
    ...
    public void showData_random(){
        TianAPI tianAPI= Retrofit2Util.getInstance().create(TianAPI.class);
        Observable<TianNews> observable=tianAPI.getAllNews("tiyus", CommonUtil.KEY,40,1,1);
        observable.observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Consumer<TianNews>() {
                    @Override
                    public void accept(@NonNull TianNews tianNews) throws Exception {
